                ...
                <div class="col-12">
                    ...
                    <div
                        ...
                        <div class="d-flex gap-2 fw-medium">
                            ...
                            <span class="title-color">{{$subscribed_sub_categories->count()}}</span>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table align-middle">
                                            ...
                                            @foreach($subscribed_sub_categories as $key=>$sub_category)
                                                <tr>
                                                    <td>{{ Str::limit($sub_category->sub_category['name'], 30) }}</td>
                                                    <td>{{ Str::limit($sub_category->category['name'], 30) }}</td>
